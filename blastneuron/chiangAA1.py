...
dirPath = os.path.join(temp1, 'OriginalData', 'chiangAA1')

# refSWC = os.path.join(temp1, 'OriginalData', 'chiangAA1', 'VGlut-F-300181_Standardized.swc')
# resPath = os.path.join(temp1, 'BlastNeuron', "chiangAA1")
# parFile = os.path.join(temp1, 'ParFiles', 'BlastNeuron', 'chiangAA1.json')

# refSWC = os.path.join(temp1, 'OriginalData', 'chiangAA1', 'VGlut-F-300181.CNG.swc')
# resPath = os.path.join(temp1, 'BlastNeuron', "chiangAA1_VGlut-F-300181.CNG")
# parFile = os.path.join(temp1, 'ParFiles', 'BlastNeuron', 'chiangAA1_VGlut-F-300181.CNG.json')
#
# refswc = os.path.join(temp1, 'OriginalData', 'chiangAA1', 'VGlut-F-600290.CNG.swc')
# resPath = os.path.join(temp1, 'BlastNeuron', "chiangAA1_VGlut-F-600290.CNG")
# parFile = os.path.join(temp1, 'ParFiles', 'BlastNeuron', 'chiangAA1_VGlut-F-600290.CNG.json')
#
# refSWC = os.path.join(temp1, 'OriginalData', 'chiangAA1', 'VGlut-F-500147.CNG.swc')
# resPath = os.path.join(temp1, 'BlastNeuron', "chiangAA1_VGlut-F-500147.CNG")
# parFile = os.path.join(temp1, 'ParFiles', 'BlastNeuron', 'chiangAA1_VGlut-F-500147.CNG.json')

refSWC = os.path.join(temp1, 'OriginalData', 'chiangAA1', 'VGlut-F-300181_Standardized.swc')
resPath = os.path.join(temp1, 'BlastNeuron_likeStandardized', "chiangAA1")
parFile = os.path.join(temp1, 'ParFiles', 'BlastNeuron', 'chiangAA1_likeStandardized.json')
